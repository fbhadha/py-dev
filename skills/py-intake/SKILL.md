...
6. After the merge, one question: "Protect `main` on the server, so nothing lands there except a merge with green checks, from any tool or person?" Yes, GitHub:
