...
2. **<Slice name>**
   - Test first: `tests/<tier>/test_<module>.py::test_<behaviour>`; seam: <the public function or port>; expected value from: <spec line, worked example, fixture>.
